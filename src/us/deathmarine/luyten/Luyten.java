...
public class Luyten {
    ...
    public static MainWindow getMainWindow() {
        return mainWindowRef.get();
    }

    public static void main(final String[] args) {
        System.out.println(Luyten.class.getResource("/resources/yml.png").getPath());
        if (ArrayUtils.isEmpty(args)) {
            MenuRegister.createProjectMenuRegistry();
            MenuRegister.createDeleteProjectMenuRegistry();
        }
